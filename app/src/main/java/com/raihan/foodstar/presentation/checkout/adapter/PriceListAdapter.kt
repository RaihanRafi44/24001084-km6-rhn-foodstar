package com.raihan.foodstar.presentation.checkout.adapter
...
import com.raihan.foodstar.databinding.ItemTotalPriceAllMenuBinding
...
class PriceListAdapter(private val itemClick: (PriceItem) -> Unit) :
    ...
    override fun onCreateViewHolder(
        ...
        val binding = ItemTotalPriceAllMenuBinding.inflate(LayoutInflater.from(parent.context), parent, false)
